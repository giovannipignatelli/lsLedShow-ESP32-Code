...
void setup() {
  ...
  myShow.addStage("Primo").addLevel().addSequence(new lsSequenceFill()).setColoring(LS_FILL_TYPES::SOLID).setColors(CRGB::Green,CRGB::Green,CRGB::Green).setDuration(ONESECOND);
  ...
  myShow.addStage("Primo").addLevel().addSequence(new lsSequenceLightning(10)).setColors(CRGB::Green).setDuration(20*FRAMES_PER_SECOND);
